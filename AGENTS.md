...
3. `skills/mvp/references/editing-rules.md` — the rules for every edit to the docs above.
...
- Run `scripts/check-doc.sh ROADMAP.md docs/plans/*.md` after editing any doc.
