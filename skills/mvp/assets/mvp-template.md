...
> - **Stories** are task-list one-liners under their epic — drafted here, but in the emitted docs they live in the epic's own `docs/epics/E<nn>-<slug>.md` file, never inline in the index: each independently shippable, verifiable, small enough for one PR, and tickable as work lands. Lead with an action verb — "Add …", "Ship …", "Template …" — and stay within two sentences.
